  ...
  return (
    <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 py-12 sm:py-16">
      <header className="mb-12 sm:mb-16">
        <p className="text-[11px] font-bold uppercase tracking-widest text-zinc-400 mb-2">Writing</p>
        <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-zinc-950">My Scratchpad</h1>
        <p className="mt-2 text-sm text-zinc-500">
          Notes on building AI systems, Machine Learning, distributed infrastructure, navigating life, chaos, and software craft.
        </p>
      </header>
