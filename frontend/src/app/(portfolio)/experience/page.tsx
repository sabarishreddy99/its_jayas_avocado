...
export const metadata = {
  title: "Experience",
  description:
    "5+ years building production AI and distributed systems, NYU High-Speed Research Network, Shell PLC, Wipro. From maritime telemetry at 115 GB/day to 3 K+ RPS RAG pipelines.",
